...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  function registerClientPortalRoutes(app: Express) {
  ...
  // TODO: Move all /api/services routes here
  ...
  // You can continue with storing imageData or sending a response here
});
