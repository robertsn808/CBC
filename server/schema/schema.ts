...
date("my_column").$type<Date>().notNull()
...
export const galleryImages = pgTable("gallery_images", {
  ...
  url: text("url"),
  // ✅ this is correct
  aiAnalysis: jsonb("ai_analysis").$type<z.infer<typeof aiAnalysisSchema>>(),
});
...
export type ClientPortalSession = InferSelectModel<typeof clientPortalSessions>;
export type InsertClientPortalSession = InferInsertModel<typeof clientPortalSessions>;
